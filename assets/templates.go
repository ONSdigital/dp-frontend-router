...
func redirectsRedirectsCsv() (*asset, error) {
	...
	info := bindataFileInfo{name: "redirects/redirects.csv", size: 21972, mode: os.FileMode(420), modTime: time.Unix(1558623819, 0)}
	a := &asset{bytes: bytes, info: info}
	return a, nil
}
