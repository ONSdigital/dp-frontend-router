...
func redirectsRedirectsCsv() (*asset, error) {
	...
	info := bindataFileInfo{name: "redirects/redirects.csv", size: 20208, mode: os.FileMode(420), modTime: time.Unix(1539180881, 0)}
	a := &asset{bytes: bytes, info: info}
	return a, nil
}
