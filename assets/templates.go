...
func templatesMainTmpl() (*asset, error) {
	...
	info := bindataFileInfo{name: "templates/main.tmpl", size: 3324, mode: os.FileMode(420), modTime: time.Unix(1485255525, 0)}
	a := &asset{bytes: bytes, info: info}
	return a, nil
}
...
func templatesPartialsFooterTmpl() (*asset, error) {
	...
	info := bindataFileInfo{name: "templates/partials/footer.tmpl", size: 2545, mode: os.FileMode(420), modTime: time.Unix(1485255533, 0)}
	a := &asset{bytes: bytes, info: info}
	return a, nil
}
